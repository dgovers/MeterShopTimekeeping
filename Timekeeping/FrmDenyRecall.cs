...
{
    public partial class FrmDenyRecall : Form
    {
        ...
        public FrmDenyRecall(FrmEditTimesheet formEditTimesheet, FrmTimesheetsApprovers formTimesheetsApprovers)
        {
            InitializeComponent();
        ...
        private void FrmDenyRecall_Load(object sender, EventArgs e)
        {
            getCurrentUserInfo();
            getTimesheetInfo();
        }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(dbHandler.GetConnectionString()))
            {
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"INSERT INTO [dbo].[tblTimesheetComments](TimesheetID,CommentsTimestamp,EmpID,Comment)VALUES(@timeSheetID,getdate(),@currentEmpID,'TIMESHEET RECALL DENIED.')";
            ...
            mail.Subject = "MeterShop Timekeeping - Timesheet #" + timeSheetID.ToString() + " - RECALL REQUEST DENIED.";
            mail.IsBodyHtml = true;
            mail.Body = "The request to recall timesheet #" + timeSheetID.ToString() + " has been denied per " + currentUserName.ToString() + " because ,\"" + richTextBoxComment.Text.ToString().ToString() + "\".";
